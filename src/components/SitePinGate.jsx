...
const PIN_KEY      = 'site_pin_unlocked_at'
const FAIL_KEY     = 'site_pin_fail_count'
const LOCKOUT_KEY  = 'site_pin_lockout_until'
...
export default function SitePinGate({ children }) {
  ...
  function verify(pin) {
    ...
    if (pin === import.meta.env.VITE_SITE_PIN) {
      clearFails()
  ...
  return (
    <div style={{
      ...
      >
        ...
        <div style={{ fontSize: 18, fontWeight: 700, color: 'var(--text-primary)' }}>請輸入通行碼</div>
